...
class Home extends Component<{}, State> {
    ...
    componentDidMount() {
        ...
        this.interval = setInterval(this.addRandomDataPoint, 1000);
    }
    ...
    <div className="main">
        ...
        <div className="content">
            ...
            <div className="graphs">
                ...
                <Line data={chartData} options={chartOptions} id="chart2" />
                <Line data={chartData} options={chartOptions} id="chart3" />
            </div>

            <div className="graphs">
                <Line data={chartData} options={chartOptions} id="chart4" />
                <Line data={chartData} options={chartOptions} id="chart5" />
                <Line data={chartData} options={chartOptions} id="chart6" />
            </div>
        </div>
