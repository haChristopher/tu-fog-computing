...
class SensorData_2:
    def __init__(self):
        ...
        self.temperature_range = (18.0, 23.0)
        self.pressure_range = (1020.0, 1060.0)
        self.humidity_range = (40, 47)
        self.wind_speed_range = (45.0, 63.0)
        self.weather_naming_options = ['Partly cloudy', 'Sunny', 'Rainy', 'Light rain', 'Cloudy']
        self.cities = ['Berlin', 'Hamburg', 'Munich']

    def generate_sensor_data(self):
        if(generate_data == True):
            print(f"[weather-parser] - Simulating environmental data for [{self.cities[1]}]")
            ...
            try:
                print(f"[weather-parser] - Parsing environmental data from API for [{self.cities[1]}]")
                city = self.cities[1]
